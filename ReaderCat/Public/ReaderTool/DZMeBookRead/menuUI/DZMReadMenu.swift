...
@objc protocol DZMReadMenuDelegate:NSObjectProtocol {
    ...
    /// 点击订阅按钮
    @objc optional func readMenuClickSubscribeButton(readMenu:DZMReadMenu, button:UIButton)
    
    /// 点击评论按钮
    @objc optional func readMenuClickCommentButton(readMenu:DZMReadMenu, button:UIButton)
