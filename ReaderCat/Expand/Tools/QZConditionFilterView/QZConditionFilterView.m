...
- (void)prepareUIWithBtn:(UIButton *)btn
{
    ...
    if (btn == _dataSource1Btn) {
        _filterTableView1 = [[QZFilterDataTableView alloc] initWithFrame:CGRectMake(0, 40+StatusBarHeight+NavigationBarHeight, self.width, 0)];
        ...
        _filterTableView2 = [[QZFilterDataTableView alloc] initWithFrame:CGRectMake(0, 40+StatusBarHeight+NavigationBarHeight, self.width, 0)];
        ...
        _filterTableView3 = [[QZFilterDataTableView alloc] initWithFrame:CGRectMake(0, 40+StatusBarHeight+NavigationBarHeight, self.width, 0)];
