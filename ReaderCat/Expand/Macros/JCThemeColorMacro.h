 ...
 * 黑色
 */
#define BlackColor UIColorFromRGBValue(0X000000)
/**
 *  主题颜色
 */
#define ThemeColor UIColorFromRGBValue(0Xffd804)
/**
 *  主题辅助颜色（状态，提示等...）
 */
 ...
 *  占位字体灰色
 */
#define PlaceHolderGrayColor UIColorFromRGBValue(0X999999)
/**
 *  线条灰色
 */
#define LineGrayColor UIColorFromRGBValue(0Xb9b9b9)
/**
 *  遮盖半透明色
 */
